...
CURRENT_SAME_SPEC_SERVER_PARAMETERS_JSON=${CURRENT_SAME_SPEC_SERVER_PARAMETERS_JSON:-}
...
resolve_same_spec() {
  ...
  if [[ -n "$CURRENT_SAME_SPEC_SERVER_PARAMETERS_JSON" ]]; then
    resolve_args+=(--server-parameters-json "$CURRENT_SAME_SPEC_SERVER_PARAMETERS_JSON")
  fi
